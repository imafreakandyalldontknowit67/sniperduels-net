...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = [
    ...
    { path: '/free-gems',      priority: 0.8,  changeFrequency: 'monthly' as const },
    { path: '/best-settings',  priority: 0.8,  changeFrequency: 'monthly' as const },
    { path: '/case-odds',      priority: 0.8,  changeFrequency: 'weekly'  as const },
